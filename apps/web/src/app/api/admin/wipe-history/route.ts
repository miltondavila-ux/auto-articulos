...
// (TitleEvent, Title, Run) acumulado durante el desarrollo, para que el
// usuario empiece con un historial limpio. No toca Credential, Category ni
// User. Se elimina después de usarse.
