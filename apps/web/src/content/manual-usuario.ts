...
- **Ficha de cada usuario:** al abrir una cuenta se ve en secciones: *Cuenta* (teléfono, dominio, servidor, credenciales, foto y logo), *Acceso* (rol, prueba gratuita y módulos), *Redes sociales y blogs*, *Imágenes con IA*, *Límites de uso para la creación de artículos*, *Acciones de la cuenta* (Acceder como, Copiar credenciales, Editar, Eliminar) e *Historial*.
