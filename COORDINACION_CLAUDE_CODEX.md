...
- **Corrección posterior validada:** el helper reconoce ahora `NUMERO-WHATSAPP` dentro de enlaces `wa.me` además de `PHONE_NUMBER` y números mal formateados. 5/5 pruebas específicas y TypeScript del worker limpios. Pendiente commit/push y nueva corrida controlada con SHA actualizado.
