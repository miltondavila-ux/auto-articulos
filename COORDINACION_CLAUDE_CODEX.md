...
- **Área reservada y modificada:**
  - `apps/web/src/components/OnboardingWizard.tsx` (nuevo componente modular autocontenido con los 4 pasos secuenciales estrictos + meta final:
    ...
    - **Paso 2 (Categorías e Idiomas)**: Solo se activa tras el Paso 1; botón para sincronizar/descargar categorías e idiomas de 10minutesWebsite en vivo con badge de estado y etiquetas.
    ...
    - **Paso 4 (Google Search Console)**: Solo se activa tras el Paso 3; instrucción explícita de abrir GSC en una pestaña contigua para verificar activación antes de conectar, enlace al videotutorial de YouTube (`https://youtu.be/c9aOFmvaHHo?si=0K0XfnbJPE2j8OMt&t=5`), flujo OAuth y selector de sitio web con auto-selección de propiedad y sitemap opcional.
